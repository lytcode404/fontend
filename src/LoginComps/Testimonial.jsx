            ...
            <div className="flex flex-col bg-white rounded-xl dark::bg-slate-900">
              <div className="flex-auto p-4 md:p-6">
                <p className="text-base italic md:text-lg text-gray-800 dark::text-gray-200">
                  ...
                  costly mistakes. But since I started working with Nextgen
                  Navigator, I&apos;ve been relax knowing that my finances are
                  in good hands. Their team is professional, and always on top
                  of the latest regulations and best practices.
                </p>
              </div>
              <div className="p-4 bg-gray-100 rounded-b-xl md:px-7 dark::bg-slate-700">
                <div className="flex items-center">
