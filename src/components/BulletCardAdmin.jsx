...
const BulletCardAdmin = ({ title, image, activeCategoryName }) => {
  return (
    <>
      <Head>
  <style>
    ...
    `}
      ...
      <Link 
        legacybehaviour
        href={`/admin/create-exam?activeCategoryName=${activeCategoryName}&categoryTitle=${title}`}
        id="card"
...
export default BulletCardAdmin;
